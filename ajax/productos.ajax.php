...
if(isset($_POST['accion']) && $_POST['accion'] == 1){ //Parámetro para listar productos

    $productos = new ajaxProductos();
    $productos -> ajaxListarProductos();
}else if(isset($_POST['accion']) && $_POST['accion'] == 2){ //Parámetro para registrar productos
...
}else if(isset($_POST['accion']) && $_POST['accion'] == 6){ //Listado total de productos para el autocompletado

    $nombreProductos = new ajaxProductos();
    $nombreProductos -> ajaxListarNombreProductos();

}else if(isset($_POST['accion']) && $_POST['accion'] == 7){  //Obtener los datos de un producto por su codigo de barras
