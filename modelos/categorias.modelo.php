...
class CategoriasModelo{
    ...
    =============================================*/
    static public function mdlEliminarInformacion($id){
    ...
    /*static public function mdlEliminarInformacion($nombre_categoria){

        $stmt = Conexion::conectar()->prepare("DELETE FROM categorias WHERE $nombre_categoria = :$nombre_categoria");

        $stmt -> bindParam(":".$nombre_categoria, PDO::PARAM_INT);
