...
$(document).ready(function() {
    /**Envio del file del formulario mediante Ajax*/
                    ...
                    if (respuesta['totalCategorias'] > 0 && respuesta['totalProductos'] >
                        ...
                        Swal.fire({
                            ...
                            title: 'Se registraron ' + respuesta[
                                'totalCategorias'] + ' categorias y ' + respuesta[
                        ...
                        Swal.fire({
                            position: 'center',
                            icon: 'error',
                            title: 'Se presento un error al momento de realizar el registro de categorias y/o productos!',
                            showConfirmButton: false,
                            timer: 2500
                        })
