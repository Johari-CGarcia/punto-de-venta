...
<div class="content">
    <div class="container-fluid">
        <!--.Fila para criterios de búsqueda-->
        <div class="row">
            <div class="col-lg-12">
...
var accion;
var table;
var operacion_stock = 0; //permite definir si vamos a sumar o restar al stock (1:sumar, 2:restar)
...
$(document).ready(function() {
    ...
    /*Evento para limpiar los criterios de búsqueda*/
    ...
    /*Evento para limpiar el registro del producto al cancelar*/
    ...
    /*Evento al dar click en el botón aumentar stock*/
    $('#tbl_productos tbody').on('click', '.btnAumentarStock', function() {
        ...
        console.log("esta es la dta", data)
    ...
    $('#tbl_productos tbody').on('click', '.btnDisminuirStock', function() {
        ...
        var data = table.row(this).data(); //OBTENER EL ARRAY CON LOS DATOS DE CADA COLUMNA DEL DATATABLE
    ...
    $('#tbl_productos tbody').on('click', '.btnEditarProducto', function() {
        ...
        //var data = table.row(this).data();
        console.log("🚀 ~ file: productos.php ~ line 689 ~ $ ~ data", data)
    ...
    $('#tbl_productos tbody').on('click', '.btnEliminarProducto', function() {
        ...
        accion = 5; //seteamos la accion para eliminar producto
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        success: function(respuesta) {
                            //console.log('Estamos comprobando la respuesta' + respuesta)
