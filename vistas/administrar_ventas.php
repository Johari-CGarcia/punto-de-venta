...
$(document).ready(function() {
        ...
        drawCallback: function(settings) {
            ...
            api.column(groupColumn, {
                ...
                if (last !== group) {
                    ...
                    console.log("🚀 ~ file: administrar_ventas.php ~ line 134 ~ nroBoleta",
                        nroBoleta)
                    ...
                    $(rows).eq(i).before(
                        ...
                        ' class="fas fa-trash fs-6 text-danger mx-1 btnEliminarVenta" style="cursor:pointer;"></i> <i nroBoleta = ' +
                        nroBoleta +
    ...
    $('#lstVentas tbody').on('click', '.btnEliminarVenta', function() {
        ...
        Swal.fire({
            title: '¿Está seguro de eliminar esta boleta de venta?',
            icon: 'warning',
        ...
        table = $('#lstVentas').DataTable({
            ...
            ajax: {
                ...
                "dataSrc": function(respuesta) {
                    ...
                    var TotalVenta = 0.00;
                    for (let i = 0; i < respuesta.length; i++) {
                        TotalVenta = parseFloat(respuesta[i][5].replace('S./ ', '')) +
            ...
            drawCallback: function(settings) {
                ...
                api.column(groupColumn, {
                    ...
                    if (last !== group) {
                        ...
                        nroBoleta = nroBoleta.split(":")[1].trim();
                        console.log(
                            "🚀 ~ file: administrar_ventas.php ~ line 134 ~ nroBoleta",
                            nroBoleta)
                        ...
                        $(rows).eq(i).before(
                            ...
                            nroBoleta +
                            ' class="fas fa-edit fs-6 text-warning mx-2 btnEditarVenta fw-bold" style="cursor:pointer;"></i>' +
                            group +
                            '</td>' +
                            '</tr>'
                        );
    ...
    /***************************************************
     * *************************************************
     * Eventos para editar una venta existente
     ***************************************************
     **************************************************/
    $('#lstVentas tbody').on('click', '.btnEditarVenta', function() {

        nroBoleta = $(this).attr("nroBoleta");//Para capturar el dato del elemento al que le dio click
        ...
        $('#tblDetalleVenta').DataTable({
            ...
            ajax: {
                ...
                "dataSrc": function(output){
                    console.log("administrar_ventas.php", output["data"])
